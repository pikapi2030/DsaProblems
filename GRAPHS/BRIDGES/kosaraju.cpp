...
using namespace std;
/*
this is used to find scc(strongly connected components)(scc only valid for directed graphs)
scc is a set of nodes in graph, in which every node can reach every other node
*/
